...
import {addProduct, getDiscounts, getProductCategories, getProducts, updateProduct} from "../postgre";
...
export function productRoute(app: Application, upload: multer.Multer) {
    app.get("/product", async (req: Request, res: Response) => {
        ...
        try {
            ...
            const result = await Promise.all([getProductCategories(), getDiscounts(), getProducts()]);
            res.render("product", {
